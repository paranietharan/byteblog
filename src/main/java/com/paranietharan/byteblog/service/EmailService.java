...
public class EmailService {
    ...
    public void sendVerificationEmail(String email, String name, String verificationToken) {
        ...
        log.info("Email verification link: http://localhost:8080/api/v1/auth/verify-email?token={}", verificationToken);
    }
    ...
    public void sendEmailChangeVerification(String newEmail, String name, String verificationToken) {
        ...
        log.info("Email change link: http://localhost:8080/api/v1/users/email/verify-change?token={}", verificationToken);
    }
